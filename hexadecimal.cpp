// Copyright Zaida Hammel 2023
//
// Created by Zaida Hammel
// Created in Jan 2023
// This program converts a string to hexidecimal
...
std::string convertStringToHex(std::string string) {
    ...
    std::map<char, std::string> dictionary = {
        ...
        {'%', "0x25"},
        {'&', "0x26"},
        // 27 is a single quotation, can't add
        {'(', "0x28"},
        {')', "0x29"},
        {'*', "0x2a"},
        {'+', "0x2b"},
...
int main() {
    ...
    std::cout << "This program converts string to hexadecimal."
    << std::endl;
    std::cout << "Enter a string you would like to convert: ";
